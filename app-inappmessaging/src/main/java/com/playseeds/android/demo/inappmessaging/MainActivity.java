...
public class MainActivity extends Activity implements InterstitialListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Seeds.interstitials().fetch(APP_LAUNCH_INTERSTITIAL_ID, "interstitial_1");
        Seeds.interstitials().fetch(PURCHASE_INTERSTITIAL_ID, "interstitial_2");
        Seeds.interstitials().fetch(SHARING_INTERSTITIAL_ID, "interstitial_3");
    }
    ...
    public void showInterstitial(final String messageId, final String context) {
        ...
        if (Seeds.interstitials().isLoaded(messageId)) {
            ...
            Seeds.interstitials().fetch(messageId, context);
        }
    }
    ...
    public void onClick(SeedsInterstitial seedsInterstitial) {
        ...
        if (seedsInterstitial.getPrice().equals(SeedsInterstitial.NO_PRICE)) {
            ...
            Toast.makeText(this, "inAppMessageClickedWithDynamicPrice(interstitialId = " +
                    seedsInterstitial.getInterstitialId() + ", price = " + seedsInterstitial.getPrice() + ")", Toast.LENGTH_SHORT).show();
        }
